                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="toch-photo">
                                                <a href="#"><img
                                                            src="../../../../../../app/images/<?= $data['product']['images']; ?>"
                            ...
                            <div class="toch-prond-menu">
                                <ul role="tablist">
                                    <li role="presentation" class=" active"><a href="#display-1" role="tab"
                                                    ...
                                                    src="../../../../../../app/images/<?= $data['product']['images']; ?>"
                                                    alt="#"/></a></li>
                                    <li role="presentation"><a href="#display-2" role="tab" data-toggle="tab"><img
                                                    src="../../../../../../img/toch/2.jpg" alt="#"/></a></li>
                                    <li role="presentation"><a href="#display-3" role="tab" data-toggle="tab"><img
                                                    src="../../../../../../img/toch/3.jpg" alt="#"/></a></li>
                                    <li role="presentation"><a href="#display-4" role="tab" data-toggle="tab"><img
                                                    src="../../../../../../img/toch/4.jpg" alt="#"/></a></li>
                                </ul>
                            </div>
                            <!-- End Toch-prond-Menu -->
                        </div>
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <div class="about-toch-prond">
                                ...
                                <span class="item-stock">Наявність: <span
                                            class="text-stock"><?= $data['product']['count']; ?></span></span>
                            </div>
                            ...
                            <div class="product-quantity">
                                <span>Qty</span>
                                <input id="countToCart" type="number" placeholder="1" value="1"/>
                                <button id="inCart" type="submit" class="toch-button toch-add-cart">В корзину</button>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <p>It is part of Australia's network of offshore
                                                                        ...
                                                                        facing deportation from Australia.</p>
                                ...
                                <div class="active-product-carosel">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-img" src="../../../img/product/mediam/3bg.jpg"
                                                         alt="Product">
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-img" src="../../../img/product/mediam/1.jpg"
                                                         alt="Product">
                                                </a>
                                            </div>
                                            <div class="product-description">
