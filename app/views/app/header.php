...
<html class="no-js" lang="">
    <head>
		...
		<!-- favicon
		============================================ -->		
        <link rel="shortcut icon" type="image/x-icon" href="http://localhost/img/favicon.ico">
       ...
       <link href='https://fonts.googleapis.com/css?family=Roboto:400,700' rel='stylesheet' type='text/css'>
        ...
        <link rel="stylesheet" href="http://localhost/css/owl.theme.css">
        <link rel="stylesheet" href="http://localhost/css/owl.transitions.css">
		<!-- nivo slider CSS
		============================================ -->
		<link rel="stylesheet" href="http://localhost/css/nivo-slider.css" type="text/css" />
		<!-- meanmenu CSS
		============================================ -->
        <link rel="stylesheet" href="http://localhost/css/meanmenu.min.css">
		<!-- jquery-ui CSS
		============================================ -->
        <link rel="stylesheet" href="http://localhost/css/jquery-ui.css">
		<!-- animate CSS
		============================================ -->
        <link rel="stylesheet" href="http://localhost/css/animate.css">
		<!-- main CSS
		============================================ -->
		...
		<!-- responsive CSS
		============================================ -->
        <link rel="stylesheet" href="http://localhost/css/responsive.css">
    </head>
    <body>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="top-menu">
								<!-- Start Language -->
								<ul class="language">
									<li><a href="#"><img class="right-5" src="http://localhost/img/flags/gb.png" alt="#">English<i class="fa fa-caret-down left-5"></i></a>
										<ul>
											<li><a href="#"><img class="right-5" src="http://localhost/img/flags/fr.png" alt="#">French</a></li>
											<li><a href="#"><img class="right-5" src="http://localhost/img/flags/gb.png" alt="#">English</a></li>
										</ul>
									</li>
								</ul>
								<!-- End Language -->
							...
							<div class="top-link">
								<ul class="link">
									<li><a href="http://localhost/user/login"><i class="fa fa-key fa-fw"></i>Вхід</a></li>
									<li><a href="http://localhost/user/account"><i class="fa fa-user"></i>Аккаунт</a></li>
									...
									<li><a href="http://localhost/user/register"><i class="fa fa-unlock-alt"></i>Реєстрація</a></li>
								</ul>
							</div>
							<!-- End Top-Link -->
						</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-3 col-sm-12">
							<div class="logo">
								<a href="http://localhost/products/see/0/1" title="Malias"><img src="http://localhost/img/logo.png" alt="Malias"></a>
							</div>
						</div>
